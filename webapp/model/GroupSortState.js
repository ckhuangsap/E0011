sap.ui.define([
	...
	return BaseObject.extend("ZXDEGUI0011.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias ZXDEGUI0011.model.GroupSortState
		 */
		...
		/**
		 * Groups by Basamt, or resets the grouping for the key "None"
		 *
		 * @param sKey - the key of the field used for grouping
		 * @returns {sap.ui.model.Sorter[]} an array of sorters
		 */
		group: function(sKey) {
			...
			if (sKey === "Basamt") {
				...
				this._oViewModel.setProperty("/sortBy", "Basamt");

				aSorters.push(
					new Sorter("Basamt", false,
						this._fnGroupFunction.bind(this))
				);
			} else if (sKey === "None") {
				// select the default sorting again
				this._oViewModel.setProperty("/sortBy", "Guino");
			}
