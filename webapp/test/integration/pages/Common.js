sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("ZXDEGUI0011/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#ZXDEGUI0011-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#ZXDEGUI0011-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("ZXDEGUI0011.test.integration.pages.Common", {
		...
		getMockServer: function() {
			return new Promise(function(success) {
				Opa5.getWindow().sap.ui.require(["ZXDEGUI0011/localService/mockserver"], function(mockserver) {
